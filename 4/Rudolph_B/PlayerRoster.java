...
public class PlayerRoster {
   public static void main(String[] args) {
      ...
      System.out.println("Player 1 -- Jersey number: " + jerseyNumber[0] + ", Rating: " + playerRating[0]);
      System.out.println("Player 1 -- Jersey number: " + jerseyNumber[1] + ", Rating: " + playerRating[1]);
      System.out.println("Player 1 -- Jersey number: " + jerseyNumber[2] + ", Rating: " + playerRating[2]);
      System.out.println("Player 1 -- Jersey number: " + jerseyNumber[3] + ", Rating: " + playerRating[3]);
      System.out.println("Player 1 -- Jersey number: " + jerseyNumber[4] + ", Rating: " + playerRating[4]);
      //MENU
      ...
      while(choice != 'q'){
         if(choice == 'u'){
            ...
            System.out.println("\nABOVE " + newRating);
            for(l = 0; l < playerRating.length; ++l){
