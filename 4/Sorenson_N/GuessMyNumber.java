...
public class GuessMyNumber{
   ...
   System.out.println("What is the lower guess range?");
   userMin = in.nextInt();
   System.out.println("What is the upper guess range?");
   userMax = in.nextInt();
   ...
   if (numGuesses == 6){
      System.out.println("Sorry! You have reached the maximum number of tries, to no avail. The number was: " + compNum);
   }
   }//end main
