...
public class ReadWrite{
   ...
   public static String next_line(Scanner in) {
      //file_Scanner = openfile();
      String file_text = in.nextLine();
	...
	public static Scanner open_file(String	trivia_file, Scanner inFS) {
      ...
      try {
         ...
         //File file = new File(file_name); NOT SURE IF THIS THNG WORKs
        ...
        inFS = new Scanner(file);
         ...
         System.out.println("We've run into a problem :(");
         System.out.println("Can't open file "+trivia_file+" for reading.");
      }
